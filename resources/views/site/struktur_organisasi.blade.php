    ...
    <div class="org-chart-box">
        <div class="org-level-1">
            <div class="org-person">
                <img src="{{ asset('asset/img/Direktur.jpg')}}" alt="Direktur" class="org-person-img">
        ...
        <div class="org-level-2">
            <div class="org-person">
                <img src="{{ asset('asset/img/WakilDirektur1.jpg')}}" alt="Wakil Direktur 1" class="org-person-img">
            ...
            <div class="org-person">
                <img src="{{ asset('asset/img/WakilDirektur2.jpg')}}" alt="Wakil Direktur 2" class="org-person-img">
