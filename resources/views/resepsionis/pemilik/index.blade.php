            ...
            <div class="col-md-12">
                <div class="card mb-4">
                                ...
                                <tr class="align-middle">
                                    ...
                                    <td>
                                        ...
                                        <div class="btn-group" role="group">
                                            <a href="{{ route('resepsionis.pemilik.edit', ['id' => $key]) }}" class="btn btn-sm btn-warning">
                                                <i class="bi bi-pencil-square"></i> Edit
                                            </a>
                                            <form action="{{ route('resepsionis.pemilik.destroy', ['id' => $key]) }}" method="POST" style="display:inline-block;" onsubmit="return confirm('Yakin ingin menghapus data ini?');">
                                                @csrf
                                                @method('DELETE')
                                ...
                                <tr>
                                    <td colspan="5" class="text-center">
                                        <div class="d-flex flex-column align-items-center py-4">
                                            ...
                                            <h5 class="text-muted">Data pemilik masih kosong</h5>
                                            <p class="text-muted">Silakan tambah data pemilik baru</p>
                    ...
                    <div class="card-footer clearfix">
                        <div class="float-start">Menampilkan {{ $pemilik->count() }} data pemilik</div>
                        <div class="float-end">
