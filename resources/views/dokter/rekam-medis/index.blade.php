...
<div class="app-content-header">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6"><h3 class="mb-0">Rekam Medis - Dokter</h3></div>
            <div class="col-sm-6">
                ...
                <div class="card mb-4">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <a href="{{ route('dokter.dashboard') }}" class="btn btn-secondary btn-sm ms-2"><i class="bi bi-arrow-left"></i> Dashboard</a>
                        </div>
                    </div>
                    <div class="card-body">
                        @if (session('success'))
