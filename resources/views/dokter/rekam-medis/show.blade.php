      ...
      <div class="col-md-10">
        <div class="card">
          <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <div>
              <a href="{{ route('dokter.rekam-medis.index') }}" class="btn btn-sm btn-secondary ms-2">Kembali</a>
            </div>
          </div>
          <div class="card-body">
            <dl class="row">
              ...
              <dt class="col-sm-3">Tindakan Terapi</dt>
              <dd class="col-sm-9">{{ isset($tindakan) ? ($tindakan->kode . ' - ' . $tindakan->deskripsi_tindakan_terapi) : '-' }}</dd>
            </dl>
          </div>
        </div>
      </div>
