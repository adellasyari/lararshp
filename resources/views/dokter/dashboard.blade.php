...
<div class="app-content">
    <div class="container-fluid">
        @php
                ...
                $tindakanCount = isset($tindakans) ? count($tindakans) : 0;
        @endphp
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="card shadow-sm">
                    <div class="card-body d-flex align-items-center gap-3">
                        ...
                        <div>
                            <h4 class="mb-0">{{ $tindakanCount }}</h4>
                            <small class="text-muted">Tindakan Terapi</small>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <div class="d-grid gap-2">
                            <a href="{{ route('dokter.rekam-medis.index') }}" class="btn btn-outline-primary">Lihat Rekam Medis</a>
                            <!-- Dokter tidak memiliki akses pengelolaan Tindakan Terapi; hanya memilih saat pemeriksaan -->
                            <a href="{{ route('dokter.rekam-medis.create') }}" class="btn btn-outline-warning">Tambah Rekam</a>
                        </div>
                    </div>
                </div>
