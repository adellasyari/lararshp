                                ...
                                <tr class="align-middle">
                                    ...
                                    <td>
                                        ...
                                        <div class="btn-group" role="group">
                                            <a href="{{ route('admin.pemilik.edit', ['id' => $key]) }}" class="btn btn-sm btn-warning">
                                                <i class="bi bi-pencil-square"></i> Edit
                                            </a>
                                            <form action="{{ route('admin.pemilik.destroy', ['id' => $key]) }}" method="POST" style="display:inline-block;" onsubmit="return confirm('Yakin ingin menghapus data ini?');">
                                                @csrf
                                                @method('DELETE')
