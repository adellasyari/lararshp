...
<div class="app-content-header">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6"><h3 class="mb-0">Edit Pet</h3></div>
            <div class="col-sm-6">
            ...
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Ubah Data Pet</h3>
                    </div>
                    <form action="{{ route('admin.pet.update', $pet->getKey()) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="card-body">
                            @if (session('error'))
                            ...
                            <div class="mb-3">
                                ...
                                <div>
                                    <label class="me-3"><input type="radio" name="jenis_kelamin" value="J" {{ old('jenis_kelamin', $pet->jenis_kelamin) == 'J' ? 'checked' : '' }}> Jantan</label>
                                    <label><input type="radio" name="jenis_kelamin" value="B" {{ old('jenis_kelamin', $pet->jenis_kelamin) == 'B' ? 'checked' : '' }}> Betina</label>
                                </div>
