        ...
        <div class="row">
            <div class="col-md-8">
                <div class="card card-warning">
                    ...
                    <form method="POST" action="{{ route('admin.kategori-klinis.update', $kategoriKlinis->getKey()) }}">
                        @csrf
                        @method('PUT')
                        <div class="card-body">
                            @if (session('error'))
            ...
            <div class="col-md-4">
                <div class="card card-info">
                    <div class="card-header"><h3 class="card-title">Informasi Edit</h3></div>
                    <div class="card-body">
                        <p><strong>Data Saat Ini:</strong></p>
                        <div class="bg-light p-3 rounded mb-3">
                            <small class="text-muted">Nama Kategori Klinis:</small><br>
                            <strong>{{ $kategoriKlinis->nama_kategori_klinis }}</strong>
                        </div>
                        ...
                        <div class="alert alert-warning mt-3">
                            ...
                            <small><strong>Perhatian:</strong> Perubahan data ini akan mempengaruhi semua data terkait yang menggunakan kategori klinis ini.</small>
                        </div>
                    </div>
                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', function(e) {
        ...
        if (!confirm('Apakah Anda yakin ingin mengupdate data kategori klinis ini?')) {
            e.preventDefault();
            return false;
        }
    });
