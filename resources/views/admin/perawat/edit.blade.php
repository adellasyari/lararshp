                    ...
                    <form action="{{ route('admin.perawat.update', $user->id) }}" method="POST">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="no_hp" id="no_hp" class="form-control @error('no_hp') is-invalid @enderror" value="{{ old('no_hp', optional($user->perawat)->no_hp) }}">
                                @error('no_hp') <div class="invalid-feedback">{{ $message }}</div> @enderror
                            </div>

                            <div class="mb-3">
                                <label for="pendidikan" class="form-label">Pendidikan</label>
                                <input type="text" name="pendidikan" id="pendidikan" class="form-control @error('pendidikan') is-invalid @enderror" value="{{ old('pendidikan', optional($user->perawat)->pendidikan) }}">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="jenis_kelamin" id="jenis_kelamin" class="form-select @error('jenis_kelamin') is-invalid @enderror">
                                    ...
                                    <option value="L" {{ old('jenis_kelamin', optional($user->perawat)->jenis_kelamin) == 'L' ? 'selected' : '' }}>Laki-laki</option>
                                    <option value="P" {{ old('jenis_kelamin', optional($user->perawat)->jenis_kelamin) == 'P' ? 'selected' : '' }}>Perempuan</option>
                                </select>
