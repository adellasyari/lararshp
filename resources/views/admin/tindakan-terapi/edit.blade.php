...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header"><h4>Edit Tindakan Terapi</h4></div>
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.tindakan-terapi.update', $tindakanTerapi->idkode_tindakan_terapi) }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="kode" id="kode" class="form-control @error('kode') is-invalid @enderror" value="{{ old('kode', $tindakanTerapi->kode) }}" required>
